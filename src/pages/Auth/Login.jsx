...
const Login = () => {
  ...
  return (
    <section className="pt-[90px] min-h-screen flex items-center justify-center bg-gray-100 px-4">
        ...
        <form onSubmit={submitHandler} className="space-y-5">
          <div>
            ...
            <input
              type="email"
              id="email"
              className="mt-1 p-3 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500"
