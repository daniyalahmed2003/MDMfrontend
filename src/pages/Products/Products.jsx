          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="space-y-3">
                ...
                <p className="flex items-center text-gray-700">
                  <FaClock className="mr-2 text-pink-500" /> Added: {moment(product.createdAt).fromNow()}
                </p>
                <p className="flex items-center text-gray-700">
              ...
              <div className="space-y-3">
                <p className="flex items-center text-gray-700">
                  <FaStar className="mr-2 text-pink-500" /> Rating: {product.rating}
                </p>
                <p className="flex items-center text-gray-700">
            ...
            <div className="mt-4 flex items-center gap-4">
              ...
              <button
                ...
                className="bg-pink-600 hover:bg-pink-700 text-white font-semibold py-2 px-6 rounded-lg"
              >
                Add To Cart
              </button>
            </div>
